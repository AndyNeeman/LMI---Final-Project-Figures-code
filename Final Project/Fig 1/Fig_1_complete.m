function Fig_1_complete
    function Fig_1c
        ...
        plot(t_interval, (abs(c(1,:))).^2, '-', t_interval, (abs(c(2,:))).^2, '-',ones(1,100), linspace(0,1,100), '-black');
        ylim([0, 1]);
        legend('$\left|1\right>$', '$\left|2\right>$','Interpreter','latex')
    end
